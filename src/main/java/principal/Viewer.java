...
public class Viewer extends JFrame {
    ...
    public Viewer() {
        ...
        Action newAction = new AbstractAction("Limpiar") {
            {
        ...
        Action syntaxAction = new AbstractAction("Sintaxis") {
            public void actionPerformed(ActionEvent e) {viewSyntaxTree();}
        };

        Action semanticsAction = new AbstractAction("Semantica") {
